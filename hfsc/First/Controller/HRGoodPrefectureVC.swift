...
class HRGoodPrefectureVC: HRBaseVC ,UITableViewDelegate,UITableViewDataSource,HRFilterViewDelegate {
    ...
    lazy private var headerView:HRFilterView = {
        ...
        tempView.type = 3
        tempView.setFilterCount(titleArr: ["全部","全部","销量最高"])
        tempView.delegate = self
        return tempView
    }()
    override func viewDidLoad() {
        super.viewDidLoad()
        self.setNavTitle(title: "商城专区")
        self.setUI()
        self.getData()
