...
class HRIntegralDetailVC: HRBaseVC ,UITableViewDelegate,UITableViewDataSource {
    ...
    func getData(){
        ...
        param["num"] = "10"
        HRNetwork.shared.hr_getData(cmd: "getIntegralDetailList", params: param, success: { (result) in
